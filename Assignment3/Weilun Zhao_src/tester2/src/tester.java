...
//	static String fileFolder = "src/tester2/UP/";
	static String fileFolder = "UP/";
//	static String downLoadFolder = "src/tester2/DL/";
...
//			messagePrint("mg: "+clientInfo+":"+clientNumber);
			if(clientInfo == ""){
...
//  			messagepPrint("register failed");
	...
	public static double obtain(){
		String fileInfo ="A/19/A/9999";
